			...
			<div className='p-7 text-2xl flex-1 flex-col h-screen text-black leading-8 py-2 gap-y-2 mt-16 flex-wrap'>
				...
				<div className='grid grid-cols-1 xl:grid-cols-3 xl:gap-12 pb-8'>
					<div className='col-span-2'>
						...
						<div className=' md:grid md:grid-cols-3 gap-4 justify-between  mt-10'>
							<div className='flex flex-col gap-y-4 bg-white dark:bg-dark_secondary shadow-md cursor-pointer p-4 rounded-xl pb-4 hover:scale-105 duration-500 ease-in-out '>
								<div className='flex justify-between w-auto'>
									...
									<span className='px-3 bg-[#8df4bf48] text-[#228B22] dark:text-[#66ee7e] text-[0.8rem] rounded-full flex items-center font-[700]'>
										<BsArrowUp /> 85%
									</span>
								</div>{' '}
								<div className='flex flex-col items-start'>
									...
									<span className='font-[900] text-xl dark:text-dark_text'>
										40
									</span>
								</div>
							</div>
							...
							<div className='flex flex-col gap-y-4 bg-white dark:bg-dark_secondary shadow-md cursor-pointer p-4 mt-4 md:mt-0 rounded-xl pb-4 hover:scale-105 duration-500 ease-in-out '>
								<div className='flex justify-between w-auto'>
									...
									<span className='px-3 bg-[#8df4bf48] text-ui_primary2 dark:text-[#66ee7e] text-[0.8rem] rounded-full flex items-center font-[700]'>
										<BsArrowUp /> 85%
									</span>
								</div>{' '}
								<div className='flex flex-col items-start'>
						...
						<div className='flex flex-col gap-y-4 bg-white dark:bg-dark_secondary shadow-md cursor-pointer p-4 rounded-xl pb-4 mt-8 overflow-hidden'>
							<div className='flex justify-between items-center'>
								...
								<Link
									...
									className='flex gap-x-2 text-ui_button text-[0.8rem] justify-center items-center group '
								>
									See all{' '}
						...
						{/* RECENT CAMPAIGN */}
						<div className='flex flex-col gap-y-4 bg-white dark:bg-dark_secondary shadow-md mt-8 cursor-pointer p-4 rounded-xl pb-8 '>
							<div className='flex justify-between items-center'>
								{' '}
								<h2 className='text-[1rem] text-ui_primary font-[600] dark:text-ui_button'>
							...
							<div className='flex flex-col lg:flex-row gap-4 md:gap-2 pb-4 border-b-[0.7px] border-slate-200'>
								<div className='flex flex-col items-start md:border-r-[0.5px] border-slate-200 pr-10'>
									{' '}
									<p className='text-[0.8rem] leading-4 text-slate-700'>
										<strong className='dark:text-dark_text'>
											Total Interactions
										</strong>
									</p>{' '}
									<span className='md:mt-2 text-sm text-slate-500'>400</span>
								</div>
								<div className='flex flex-col items-start md:border-r-[0.5px] border-slate-200 pr-8'>
									{' '}
									<p className='text-[0.8rem] leading-4 text-slate-700'>
										<strong className='dark:text-dark_text'>Title</strong>
									</p>{' '}
								...
								<div className='flex flex-col items-start pr-8'>
									{' '}
									<p className='text-[0.8rem] leading-4 text-slate-700'>
										<strong className='dark:text-dark_text'>Date Posted</strong>
									</p>{' '}
									<span className='md:mt-2 text-sm text-slate-500'>
										09/09/2023
									</span>
					...
					<div className='col-span-1'>
						<div className='grid grid-cols-1 gap-y-2'>
							<div className='flex flex-col gap-y-4 bg-white dark:bg-dark_secondary shadow-md cursor-pointer p-4 px-6 rounded-xl pb-4 mt-10'>
								...
								<div className='flex flex-col gap-y-2 border-b-[0.5px] pb-4 border-slate-200'>
									<div className='flex flex-row gap-4 items-center pb-2'>
										<p className='font-[600] text-[1rem] dark:text-dark_text'>
											11:00
										</p>
										...
										<div className='flex flex-col items-start'>
											...
											<span className='font-[600] text-[0.7rem] dark:text-dark_text'>
												Follow up mail
											</span>
										</div>
									</div>{' '}
									<div className='flex flex-row gap-4 items-center pb-2'>
										...
										<div className='h-full  bg-ui_button w-[0.2rem]'></div>
										<div className='flex flex-col items-start'>
											{' '}
											<p className='text-[0.7rem] leading-3 text-slate-500'>
												XYZ Fitfam Campaign
								...
								<div className='flex flex-col  pt-2'>
									...
									<Link
										...
										'
									>
										<button className='flex flex-row gap-x-4 text-ui_button bg-[#6aacf844] w-full text-[0.8rem] font-[600] rounded-xl px-2 py-1 justify-center items-center group'>
											View more schedules{' '}
											<MdArrowForwardIos className='group-hover:translate-x-2 duration-500 ease-in-out' />
										</button>
									</Link>
							...
							<div className='flex flex-col gap-y-4 bg-white dark:bg-dark_secondary shadow-md cursor-pointer p-4 px-6 rounded-xl pb-4 md:mt-10'>
