  ...
  return (
    <section>
      <div className="flex md:flex-row flex-col items-center justify-center lg:gap-20 md:gap-5 bg-white lg:px-24 md:px-10 px-7 mt-[-200px]">
        <div className="md:w-[28.8rem]  md:text-start text-center w-full md:relative top-20 md:mt-0 mt-12">
      ...
      <div className="flex relative items-center -mt-32 md:mt-0 bg-navyBlue w-full md:h-[15rem] h-[12rem]">
