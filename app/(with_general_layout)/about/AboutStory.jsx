...
const AboutStory = () => {
  return (
    <section className="max-width px-4 font-poppins text-ui_primarypy-16 flex flex-wrap items-center py-8 md:py-20 lg:py-28">
        <div className="flex flex-col md:flex-row gap-10 md:gap-0 px-16">
            <div className="px-8 py-16 md:py-0 md:p-28 lg:w-1/2">
          ...
          <div className="my-6 px-8 lg:px-44 md:my-12 lg:my-0">
              <p className="text-[#565656] text-base md:text-lg text-center md:text-left mb-4">
