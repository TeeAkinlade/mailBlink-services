								...
								{blogTitles.map(({ title, id }) => (
									<div key={id}>
										<button
											className={
												toggle === id
													? 'bg-navyBlue text-white rounded-full px-3.5 py-2 text-sm'
													: 'border border-gray-400 rounded-full px-3.5 py-2 text-sm bg-white'
											}
						...
						<section className='px-8'>
							...
							{toggle === 1 && (
								<>
									<Slider
										{...settings}
										className='grid grid-cols-1 md:grid-cols-3 lg:grid-col-3'
									>
										{blogs.map((data, id) => (
											<div
												className='w-[240px] sm:w-[275px] md:w-[280px] relative group'
												key={id}
											>
												<div className='overflow-hidden'>
													<Image
														...
														height='100'
														alt='blog image'
														className='w-full group-hover:scale-110 ease-in-out duration-500'
													/>
												</div>
												<div className='shadow-md py-5 px-4 rounded-b-2xl h-[270] md:h-[230px] bg-white'>
													...
													<div className='md:absolute bottom-7'>
														<Link
															href='#'
															className='text-xs text-navyBlue font-semibold flex items-center pt-2'
														>
															<span>Read More</span>{' '}
							...
							{toggle === 2 && (
								<Slider {...settings}>
									{webinars.map((data, id) => (
										<div
											className='w-[240px] sm:w-[275px] md:w-[280px] gap-15 relative group'
											key={id}
										>
											{' '}
											<div className='overflow-hidden'>
