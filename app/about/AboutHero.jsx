...
const AboutHero = () => {
  return (
    <section className="md:bg-white-500 mt-10 flex flex-col items-center justify-center gap-5 bg-white px-4 text-center font-poppins md:my-20 md:flex-row md:gap-10 md:px-24">
