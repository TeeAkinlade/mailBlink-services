      ...
      <div className="flex flex-col items-center px-10 md:mt-10 md:px-0">
        <div className="mt-5 grid grid-cols-1 gap-7 md:grid-cols-2 lg:grid-cols-3">
          {items.map((item, index) => (
            <div
              key={index}
              className={`transform overflow-hidden rounded-xl border-b-4 border-transparent px-5 py-5 text-center transition-transform hover:scale-105 hover:border-navyBlue hover:bg-white hover:shadow-lg`}
            >
