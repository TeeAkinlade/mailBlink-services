    ...
    <section className='bg-linear'>
        <div className="max-width padding-x">
            <div className="py-32 px-8">
                ...
                <p className='text-center padding-y font-semibold text-lg text-primaryBlack'>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-12 gap-10">
                    {servicesData.map(({ id, icon, title, contents, href, linkText }) => (
                        <div className="py-16 bg-backGround shadow-xl p-8 rounded-lg transition-all hover:scale-105 duration-200 border-b-4 border-transparent hover:border-ui_primary" key={id}>
                            ...
                            <p className='text-primaryBlaxck mb-8 text-sm md:text-[15px]'>{contents}</p>
