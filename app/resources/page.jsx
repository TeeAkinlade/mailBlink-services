            ...
            <div className="flex flex-col md:flex-row items-center gap-20 lg:gap-40">
                ...
                <div className="relative flex-center flex-col">
                    <div className="w-3/4 rotate-3">
                        <Image src='/assets/images/unsplash_8hgmG03spF4.svg' width='100' height='100' alt ='resources image' className='w-full ml-3' />
                        <div className="shadow-md py-10 px-6 rounded-b-2xl -mt-4 rotate-2 bg-white">
                            <h3 className="text-[24px] font-semibold">Personality Assessment</h3>
                            <p className="text-sm py-5">Understand yourself well with specific insights into your personality and character.</p>
                            <Link href='#' className='text-xs text-ui_secondary1 font-semibold flex items-center'><span>View More</span> <MdKeyboardArrowRight className='font-semibold ml-1' /></Link>
                        </div>
                    </div>
                    <div className="w-3/4 absolute top-5 md:top-10 -left-15 md:left-10 lg:left-10 z-20">
                        <Image src='/assets/images/eksport.svg' width='100' height='100' alt ='resources image' className='w-full' />
                        <div className="shadow-md py-10 px-6 rounded-b-2xl -mt-4 bg-white">
                            <h3 className="text-[24px] font-semibold">Personality Assessment</h3>
                            <p className="text-sm py-5">Understand yourself well with specific insights into your personality and character.</p>
                            <Link href='#' className='text-xs text-navyBlue font-semibold flex items-center'><span>View More</span> <MdKeyboardArrowRight className='font-semibold ml-1' /></Link>
                        </div>
                    </div>
                </div>
            </div>
